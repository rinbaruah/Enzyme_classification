...
```{r radplot,fig.cap="Median standaridised values for EC1 and EC2 indicators",fig.align='center'}
EC_imp <- EC1_imp
...
radarchart(EC_imp,
           cglcol="black", cglty=1, axislabcol="black", caxislabels=seq(-1,1,0.25), cglwd=0.8,
