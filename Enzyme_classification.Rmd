...
<div class="alert alert-block alert-warning">
💡 we have obtained the top 5 features using the XGBoost model for each of the EC1 and EC2 indicators. This will help us concetrate our EDA efforts only on the most important features.💡
</div>
